...
func init() {
	coremain.RegNewPersetPluginFunc("_pad_query", func(bp *coremain.BP) (any, error) {
		return &PadQuery{BP: bp}, nil
	})
	coremain.RegNewPersetPluginFunc("_enable_conditional_response_padding", func(bp *coremain.BP) (any, error) {
		return &ResponsePaddingHandler{BP: bp}, nil
	})
	coremain.RegNewPersetPluginFunc("_enable_response_padding", func(bp *coremain.BP) (any, error) {
		return &ResponsePaddingHandler{BP: bp, Always: true}, nil
	})
}

var _ sequence.Executable = (*PadQuery)(nil)
var _ sequence.Executable = (*ResponsePaddingHandler)(nil)
...
func (p *PadQuery) Exec(ctx context.Context, qCtx *query_context.Context, next sequence.ChainWalker) error {
	q := qCtx.Q()
...
func (h *ResponsePaddingHandler) Exec(ctx context.Context, qCtx *query_context.Context, next sequence.ChainWalker) error {
	if err := next.ExecNext(ctx, qCtx); err != nil {
		return err
	}
